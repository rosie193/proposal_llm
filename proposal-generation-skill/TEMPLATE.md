...
5. Check against `standard_AI_modules.md` (classify as Standard or Custom)
...
| **Phase T1** | Hardware Deployment | T0 + X weeks | **Logic**:<br>- T1 = T0 + 2-4 weeks|
...
|-------|---------|------------------|
| **Module Name** | [Module Name] | **Source**: S2 - "List of VA use cases" → Convert use case to module name or **AI Modules** from 2<br>**Logic**: Use standard module name from `standard_AI_modules.md` if available, otherwise create descriptive name |
...
| **Step 4: Standard Modules** | Search Knowledge Base | Find existing module descriptions to reuse text (Purpose, Alert Logic, Preconditions) |
