...
11. **"If VA: camera status & scope"**
    - Contains: Camera information (number, existing/new, locations)
    - **Note**: Field name may vary slightly, but this is the pattern

12. **"If IoT: device status"**
...
4. **"Stable internet connection?"**
   ...
   - **Note**: Field name may have question mark at end

5. **"Can client camera provide RTSP link?"**
...
8. **"Specific HW/SW requirements (deployment method)?"**
   - Contains: Deployment method (On-premise / Cloud / Hybrid / Edge)
   - **Note**: This is the exact field name, may have question mark

9. **"Any GDPR / data privacy requirements?"**
   - Contains: Compliance requirements
   - **Note**: Field name includes "/" between GDPR and data privacy

10. **"Any customized AI use cases (description & videos)?"**
    - Contains: Custom use case descriptions
    - **Note**: Field name includes "(description & videos)"
...
12. **"Any customized HW / IoT?"**
    ...
    - **Note**: Field name has space around "/"
